...
test.describe("Auth pages", () => {
  test("login page renders email + password, Google, disabled Apple, reset link", async ({
    page,
  }) => {
  ...
  test("signup page shows password + confirm and links back to login", async ({ page }) => {
