...
_Last updated: 2026-05-31 (v1.1 auth shipped & released v0.1.2; creds moved to env-only)._
...
- **Current version:** `0.1.2` (tag `v0.1.2` cut, GitHub Release published; auth + landing-callout features).
- **Milestone:** v1.0 shipped; **v1.1 in progress** — real auth (email+password + TOTP MFA) shipped & merged to master + deployed to the Vercel Production target. Remaining: CRUD + calculator + paywall. See [PROGRESS.md](./PROGRESS.md).
